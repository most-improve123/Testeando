                      ...
                      {filteredUsers?.map((user) => (
                        <tr key={user.id} className="hover:bg-neutral-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <Badge
                              variant="secondary"
                              className="bg-secondary-green/10 text-secondary-green"
                            >
                              Active
                            </Badge>
                          </td>
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  ...
                  <DialogContent className="max-w-2xl">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <Label htmlFor="certificateBackground">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setCourseFormData({
                              ...courseFormData,
                              certificateBackground: e.target.value,
                            })
                          }
                          placeholder="https://example.com/certificate-background.png"
                        />
                        <div className="text-xs text-neutral-500 mt-1">
                          Use a high-quality PNG or JPG background image for
                          certificates
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-neutral-50 rounded-md p-3">
                            ...
                            <code className="text-xs text-neutral-600">
                              name,email,completion_date,city
                              <br />
                          ...
                          <div className="flex items-start justify-between mb-3">
                            ...
                            <div className="flex space-x-2">
                                ...
                                <DialogContent className="max-w-2xl">
                                  ...
                                  <div className="space-y-6">
                                    ...
                                    <div>
                                      ...
                                      />
                                      <div className="text-xs text-neutral-500 mt-1">
                                        e.g., fas fa-code, fas fa-brain, fas
                                        fa-palette
                                      </div>
                                    </div>
                                    ...
                                    <div>
                                      ...
                                      />
                                      <div className="text-xs text-neutral-500 mt-1">
                                        Use a high-quality PNG or JPG background
                                      ...
                                      <div className="space-y-4">
                                        <div>
                                          ...
                                          <div className="border-2 border-dashed border-neutral-300 rounded-lg p-4 text-center">
                                            <Upload className="mx-auto h-6 w-6 text-neutral-400 mb-2" />
                                            <p className="text-sm text-neutral-600 mb-2">
                                              Upload CSV with: name, email,
                                              completion_date, city
                                            </p>
                                            <input
                                              type="file"
                                              accept=".csv"
                                        ...
                                        <div className="bg-neutral-50 rounded-md p-3">
                                          ...
                                          <code className="text-xs text-neutral-600">
                                            ...
                                            <br />
                                            John
                                            Doe,john@example.com,2025-01-15,New
                                            York
                                          </code>
                                        </div>
                                      </div>
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  deleteCourseM8mutation.mutate(course.id)
                                }
